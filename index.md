...
venue: "Middlebury Institute of International Studies at Monterey"        # brief name of host site without address (e.g., "Euphoric State University")
address: "460 Pierce St., Monterey, CA"      # full street address of workshop (e.g., "Room A, 123 Forth Street, Blimingen, Euphoria")
...
language: "English (Simultaneous translation available upon request)"     # lowercase two-letter ISO language code such as "fr" (see https://en.wikipedia.org/wiki/List_of_ISO_639-1_codes)
latlng: "36.5995, 121.8972"       # decimal latitude and longitude of workshop venue (e.g., "41.7901128,-87.6007318" - use https://www.latlong.net/)
...
instructor: ["Phil Murphy"] # boxed, comma-separated list of instructors' names as strings, like ["Kay McNulty", "Betty Jennings", "Betty Snyder"]
